                    ...
                    <div class="row">
                        <style>
                            ...
                            @keyframes myanimation {
                                ...
                                25%{background-color:yellow;color:#000;}
                                50%{background-color:green;color:#fff;}
                                75%{background-color:brown;color:#fff;}
                            ...
                            <?php if(check_permission('role_1606370618_62')){ ?> <!--role_1606370617_73-->
                                <div class="btn-group" style="float: right;">
                                    ...
                                    <div class="dropdown-menu">
                                        <a href="<?php echo base_url('admin/group-booking'); ?>" class="dropdown-item"><b><i class="fas fa-plus-square"></i> &nbsp;&nbsp;Group Booking</b></a>
                                    </div>
                                </div>
                            <?php } ?>
    ...
    <div class="modal-dialog modal-xl" style="min-width:100%;min-height:100%;margin:0px;">
        <div class="modal-content">
            <form action="<?=current_url(); ?>" method="post">
                ...
                <div class="modal-body" id="building_overview_result" style="min-height:100%;overflow-y:scroll;"> </div>
            ...
            <form class="form_b_class" method="post" id="booking_form" enctype="multipart/form-data">
                ...
                <div class="modal-body"> <!-- style="max-height:780px;overflow-y:scroll;"-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                <select id="religion" name="religion" class="form-control select2" required >
                        ...
                        <div class="col-sm-3">
                            <div class="form-group" id="custom_field_one">
                                <select id="h_t_f_u" name="h_t_f_u" class="form-control select2" required >
                    ...
                    <div class="row">
                        <div class="col-sm-10">
                            <div class="row">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <select id="occupation" name="occupation" class="form-control select2" required >
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <select name="member_type" class="form-control select2" required title="Please select Member Type">
                    ...
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <select id="branch_id" name="branch_id" class="form-control select2">
                                    <option value="<?php echo $bfifpb->branch_id?>"><?php echo (!empty($branch_name->branch_name)) ? $branch_name->branch_name : ''; ?></option>;
                                    <?php
                                    if(!empty($banches)){
                                        foreach($banches as $row){
                                            if($row->branch_id != $bfifpb->branch_id){
                                                echo '<option value="'.$row->branch_id.'">'.$row->branch_name.'</option>';
                                            }
                                        }
                                    }
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="text" id="selected_package_category" value="<?php echo $bfifpb->package_category_id;?>">
                        ...
                        <div class="col-sm-3">
                            <div class="form-group">
                                ...
                                <input type="date" id="checkin_date" name="checkin_date" class="form-control" value="<?php echo $bfifpb->check_in_date; ?>" readonly/>
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="form-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <input type="hidden" value="<?php echo date('m/d/Y  h:i:s A'); ?>" id="booking_date" name="booking_date" class="form-control" readonly />
                            </div>
                        </div>
                        <div class="col-sm-2">
...
//-------------
    ...
    function booking_form_reset(){
        ...
        var category_id = $('#selected_package_category').val();
        if(branch_id != ''){
            $.ajax({
                url:"<?=base_url('assets/ajax/select_spackage_category_options.php');?>",
                method:"POST",
                data: {view_id : branch_id, category_id : category_id},
                beforeSend:function(){
                    $('#data-loading').html(data_loading);
                },
                success:function(data){
    ...
    $("#checkin_date").on("focus focusout change keyup keyown",function(){
        ...
        if($("#bet_type").val() == ''){
            ...
            if(bed_type != ''){
                $.ajax({
                    ...
                    method:"POST",
                    data:{bed_type:bed_type,branch_id:branch_id},
                    beforeSend:function(){
                        $('#data-loading').html(data_loading);
                    },
                    success:function(data){

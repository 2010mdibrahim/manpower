                            ...
                            <?php
                                if($candidate['policeClearance'] === 'yes' AND $candidate['passportPhoto'] === 'yes' AND $passportValidityYears >= 1){ 
                                    if($expYears >= 1){ ?>
                                        ...
                                        <button type="button" class="btn btn-success btn-sm" value="Ready">Ready</button>
                                ...
                                <?php }else{ ?> 
                                        ...
                                        <!-- --------- end updating musanad ready ---------- --> 
                                        <button type="button" class="btn btn-warning btn-sm" value="Not Ready">Not Ready</button>
                                <?php } ?>                       
                            <?php }else{ ?>
                                        <!-- --------- updating musanad ready ---------- -->
                                        <?php $entry = $conn->query("UPDATE passport set musanadReady = 'no' where passportNum = '".$candidate['passportNum']."'");?>
                                        <!-- --------- end updating musanad ready ---------- -->
                                    <button type="button" class="btn btn-warning btn-sm" value="Ready">Not Ready</button>
                            <?php } ?>
                            </td>
                            ...
                            <?php 
                                ...
                                if($candidate['musanadEntry'] == 'no'){?>
                                    <form action="template/musanadEntry.php" method="post">
                                        ...
                                        <button type="submit" class="btn btn-warning btn-sm" value="yes" name="musanadReady">Not Submitted</button>
                                    </form>
                                <?php }else{ ?>  
                                    <form action="template/musanadEntry.php" method="post">
                                        <input type="hidden" name="passportNum" value="<?php echo $candidate['passportNum'];?>">
                                        <button type="submit" class="btn btn-success btn-sm" value="no" name="musanadReady">Entered</button>
                                    </form>
                                <?php } ?>                      
                            <?php }else{ ?>
                                <button type="button" class="btn btn-secondary btn-sm" value="Not Ready">Not Ready</button>
                            <?php } ?>
                            </td>
                            <td>

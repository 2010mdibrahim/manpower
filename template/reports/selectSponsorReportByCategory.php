...
<script type="text/javascript">
    function fetch_select(val)
    {
        $.ajax({
            type: 'post',
            url: 'template/reports/fetchSponsorCategory.php',
            data: {
                get_option:val
            },
            success: function (response) {
                document.getElementById("visaCategory").innerHTML=response;
            }
        });
    }
        ...
        <div class="form-group">
            <div class="row">
                <div class="column col-md-6" >
                    <input type="hidden" name="pagePost" value="sponsorReportByCategory">
                ...
                <div class="column col-md-6">
                    <label for="sel1">Visa Category:</label>
                    <select class="form-control" id="visaCategory" name="visaCategory">

...
if(isset($_POST['passportNum'])){
    ...
    $result = $conn -> query("SELECT sponsorVisa, sponsorNID, jobType, visaAmount from sponsorvisalist where visaGenderType = '".strtolower($gender['gender'])."' and visaAmount > 0 order by sponsorNID");

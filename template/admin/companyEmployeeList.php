...
$qry = "SELECT employee.employeeId, employee.employeeName, employee.DOJ, employee.DOL, department.departmentId,department.departmentName, designation.designationName, salary.salaryAmount from employee 
        ...
        <table id="employeeList" class="table col-12"  style="width:100%">
            ...
            while( $employee = mysqli_fetch_assoc($result) ){ ?>
                <tr>
                    ...
                    <td><?php echo number_format($employee['salaryAmount']);?></td>

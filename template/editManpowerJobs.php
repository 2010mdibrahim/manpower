...
$office_name = mysqli_fetch_assoc($conn->query("SELECT manpowerOfficeName from manpowerOfficeName where manpowerOfficeId = $manpowerOfficeId"));

if($result){
    echo "<script> window.location.href='../index.php?page=manpowerJobList&mi=".base64_encode($manpowerOfficeId)."&mn=".base64_encode($office_name['manpowerOfficeName'])."'</script>";
}else{

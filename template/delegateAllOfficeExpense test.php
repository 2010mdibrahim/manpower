...
<div class="container-fluid" style="padding: 2%" style="width: 100%;">
    ...
    <div class="card" style="width: 100%;">
        ...
        <ul class="list-group list-group-flush">
            ...
            $manpower_processing_test = $conn->query("SELECT manpowerjobprocessing.processingCost, passport.fName from passport INNER JOIN manpoweroffice USING (manpowerOfficeName) INNER JOIN manpowerjobprocessing on manpoweroffice.manpowerOfficeId = manpowerjobprocessing.manpowerOfficeId INNER JOIN processing on processing.passportNum = passport.passportNum AND processing.passportCreationDate = passport.creationDate where passport.agentEmail = 'maheeer2010@hotmail.com' and processing.manpowerCard < 'yes'");
            foreach($manpower_processing_test as $row){
                print_r($row['processingCost'] . " - " . $row['fName']."<br>");
            }
